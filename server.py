...
CORS(app, supports_credentials= True, origins=["https://new-frontend-e40841b2a75a.herokuapp.com"]) # CORS allows react and flask to communicate, support_cred allows user auth to take place
